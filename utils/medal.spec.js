...
test('returns author medal', macro, MEDAL.AUTHOR, '<:author:1065842677020626944>');
test('returns gold medal', macro, MEDAL.GOLD, '<:gold:1065842710365351947>');
test('returns silver medal', macro, MEDAL.SILVER, '<:silver:1065842724433051748>');
test('returns bronze medal', macro, MEDAL.BRONZE, '<:bronze:1065842732259606578>');
