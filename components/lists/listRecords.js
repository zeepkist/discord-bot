...
import { bestMedal, formatLevel, formatRank, formatRelativeDate, formatResultTime, formatUser } from '../../utils/index.js';
export const listRecords = ({ records, offset = 0, showRank = false, showUser = false, showLevel = false, showMedal = false }) => records
    .map((record, index) => {
