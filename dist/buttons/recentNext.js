...
export const recentNext = {
    ...
    run: async (interaction) => {
        ...
        const offset = Number.parseInt(currentPage) * 10;
        ...
        const embed = new EmbedBuilder()
            ...
            .setFooter({
            text: `Page ${Number.parseInt(currentPage) + 1} of ${Math.ceil(bestAndWrRecords.length / 10)}. Data provided by Zeepkist GTR`
        })
            .setTimestamp();
