...
import { onDisconnect, onError, onInteractionCreate, onReady } from './listeners/index.js';
...
client.on(Events.ShardResume, (shardId, replayed) => console.log(`Resumed Shard ${shardId} | Replayed ${replayed} events.`));
