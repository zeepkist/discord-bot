    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        },
        {
          ...
          value: `Zeepkist GTR is a mod built by <@217779716289986560> to add a global time ranking system to ${hyperlink(
            'Zeepkist',
            'https://store.steampowered.com/app/1440670'
          )}\n\nYou can support the development of Zeepkist GTR on ${hyperlink(
            'Ko-fi/thundernerd',
